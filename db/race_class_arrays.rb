...
class RaceClassArrays
  ...
  BARD = ['Bard', 'bard', 'College', 'college', 'College of Glamour', 'College of Lore', 'College of Satire',
  ...
  DRUID = ['Druid', 'druid', 'Druid of the Land', 'druid of the land', 'Circle of the Land', 'circle', 'Arctic Druid', 'Druid of the Arctic', 'Druid of the Coast', 'Coastal Druid', 'Desert Druid', 'coastal druid', 'druid of the coast', 'desert druid', 'Druid of the Desert', 'druid of the desert', 'Forest Druid', 'forest druid', 'Druid of the Forest',
  ...
  MONK = ['Monk', 'monk', 'Way of the Open Hand', 'Monk (Way of the Open Hand)', 'Monk of the Open Hand', 'Monk: Way of the Open Hand',
  ...
  AASIMAR = ['Aasimar', 'aasimar', 'Protector Aasimar', 'protector aasimar', 'Scourge Aasimar',
  ...
  GITH = ['Gith', 'gith', 'Githyanki', 'githyanki', 'Githzerai', 'githzerai', 'Gith: Githyanky', 'Gith (Githyanki)', 'Gith: Githzerai', 'Gith (Githzerai)']
